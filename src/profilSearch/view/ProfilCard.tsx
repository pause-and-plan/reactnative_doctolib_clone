...
const ProfilCardFooter = (props: ProfilCardProps) => {
	...
	return <View style={{ padding: Theme.space15, alignItems: "center" }}>
		<View style={{
			flexDirection: "row",
			alignItems: "center",
		}} >
...
const ProfilCardAddress = (props: ProfilCardProps) => {
	...
	return <View style={{ padding: Theme.space5 }}>
		<View style={{
			flexDirection: "row",
			alignItems: "center",
		}} >
			<Icon name="location-outline" ionicons size={20} color={Colors.black1} />
			<Space horizontal size={10} />
			<Text style={{ fontSize: Theme.fontSize14, }}>
...
const ProfilCardHeader = (props: ProfilCardProps) => {
	const profil = props.profil;
	return <View style={{ flexDirection: "row", padding: Theme.space5 }} >
		<Image
